...
import excel using ${datadir}/BEA_Gross_Output_by_Industry_Cleaned_2021.xls, clear
drop if _n < 7
...
save ${workdir}/BEA_Gross_Output_by_Industry_Cleaned_2021, replace


* Clean employment data

import excel using ${datadir}/BEA_Employment_by_Industry_Cleaned_2021.xls, clear
...
save ${workdir}/BEA_Employment_by_Industry_Cleaned_2021, replace
	
	
* Clean value added data

import excel using ${datadir}/BEA_Value_Added_by_Industry_Cleaned_2021.xls, clear firstrow
...
save ${workdir}/BEA_Value_Added_by_Industry_Cleaned_2021, replace
	
	
* Merge datasets
	
use ${workdir}/BEA_Gross_Output_by_Industry_Cleaned_2021, clear
	
merge 1:1 indnum using ${workdir}/BEA_Employment_by_Industry_Cleaned_2021
sort indnum
drop _merge

merge 1:1 iocode using ${workdir}/BEA_Value_Added_by_Industry_Cleaned_2021
drop if _merge != 3
drop _merge
...
bys realestate (indnum): egen double employment2 = sum(employment)
bys realestate (indnum): egen double output2 = sum(output)

gen double emp_output_ratio = employment / output if realestate == 0
replace emp_output_ratio = employment2 / output2 if realestate == 1

gen double va_output_ratio = valueadded / output

sort indnum
	
drop realestate employment2 output2
	
rename output output2021
rename employment employment2021
rename valueadded valueadded2021

format emp_output_ratio va_output_ratio %12.11f

save ${workdir}/BEA_EO_and_VAO_Ratios_by_Industry_Cleaned_2021, replace
