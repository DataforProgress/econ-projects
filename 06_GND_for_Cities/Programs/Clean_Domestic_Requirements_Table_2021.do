...
import excel using ${datadir}/BEA_Industry_by_Industry_Domestic_Requirements_2021.xlsx
drop if _n <= 7
...
save ${workdir}/BEA_Industry_by_Industry_Domestic_Requirements_2021, replace
